...
export class WeatherService {
  ...
  countryCityData: { [key: string]: string[] } = {
    ...
    'Macedonia': ['Skopje', 'Bitola', 'Kumanovo', 'Tetovo'],
    ...
    'Montenegro': ['Podgorica', 'Nikšić', 'Herceg Novi', 'Pljevlja', "Berane", "Andrijevica", "Bijelo Polje"],
    ...
    'Papua': ['Port Moresby', 'Lae', 'Mount Hagen', 'Madang'],
